...
namespace Proxies\__CG__\ODE\DatasetBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Dataset extends \ODE\DatasetBundle\Entity\Dataset implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'file', 'path', 'id', 'name', 'description', 'num_instances', 'num_features', 'filetype', 'filesize', 'filename', 'results', '' . "\0" . 'ODE\\DatasetBundle\\Entity\\Dataset' . "\0" . 'temp');
        }

        return array('__isInitialized__', 'file', 'id', 'name', 'description', 'num_instances', 'num_features', 'filetype', 'filesize', 'filename', 'results', '' . "\0" . 'ODE\\DatasetBundle\\Entity\\Dataset' . "\0" . 'temp');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dataset $proxy) {
    ...
    public function setNumInstances($numInstances)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumInstances', array($numInstances));

        return parent::setNumInstances($numInstances);
    }
    ...
    public function getNumInstances()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumInstances', array());

        return parent::getNumInstances();
    }
    ...
    public function setNumFeatures($numFeatures)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumFeatures', array($numFeatures));

        return parent::setNumFeatures($numFeatures);
    }
    ...
    public function getNumFeatures()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumFeatures', array());

        return parent::getNumFeatures();
    }
