...
class appDevDebugProjectContainer extends Container
{
     ...
     *
     * @return \ODE\UserBundle\Form\Type\RegistrationFormType A ODE\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getAcmeUser_Registration_Form_TypeService()
    {
        return $this->services['acme_user.registration.form.type'] = new \ODE\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ODEAnalysisBundle', ($this->targetDirs[2].'/Resources/ODEAnalysisBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ODEAnalysisBundle', ($this->targetDirs[3].'\\src\\ODE\\AnalysisBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ODERankingBundle', ($this->targetDirs[2].'/Resources/ODERankingBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ODERankingBundle', ($this->targetDirs[3].'\\src\\ODE\\RankingBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\ODE\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ODE\\DatasetBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ODE\\AnalysisBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'ODE\\UserBundle\\Entity');
        $c->addDriver($b, 'ODE\\DatasetBundle\\Entity');
        $c->addDriver($b, 'ODE\\AnalysisBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ODEUserBundle' => 'ODE\\UserBundle\\Entity', 'ODEDatasetBundle' => 'ODE\\DatasetBundle\\Entity', 'ODEAnalysisBundle' => 'ODE\\AnalysisBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f3b568e4a625b73c00028fb8666957216a81a4fe92d418bcb7983b3c52ca0c9e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ODE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ODE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'ode_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ODE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ODE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ODE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\ODE\\UserBundle/Resources/translations\\FOSUserBundle.en.yml'), 'en', 'FOSUserBundle');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ODEAnalysisBundle', 1 => 'ODERankingBundle', 2 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ODE\\UserBundle/Resources/views'), 'ODEUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\ODE\\DatasetBundle/Resources/views'), 'ODEDataset');
        $instance->addPath(($this->targetDirs[3].'\\src\\ODE\\AnalysisBundle/Resources/views'), 'ODEAnalysis');
        $instance->addPath(($this->targetDirs[3].'\\src\\ODE\\RankingBundle/Resources/views'), 'ODERanking');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ODEUserBundle' => 'ODE\\UserBundle\\ODEUserBundle',
                'ODEDatasetBundle' => 'ODE\\DatasetBundle\\ODEDatasetBundle',
                'ODEAnalysisBundle' => 'ODE\\AnalysisBundle\\ODEAnalysisBundle',
                'ODERankingBundle' => 'ODE\\RankingBundle\\ODERankingBundle',
            ...
            'fos_user.model.user.class' => 'ODE\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'ode_user_registration',
